...
Say we wanted to create a bar plot showing the 5 most expensive airbnb neighbororhods in Portland, by average rental price. First, we can query the database to get a dataframe of all listing neighborhoods and prices:
